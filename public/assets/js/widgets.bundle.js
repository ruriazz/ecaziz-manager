...
var KTChartsWidget11 = function() {
    var e = function(e, t, a, r) {
        ...
        if (i) {
            ...
            !0 === r && (c.render(), u = !0), m.addEventListener("shown.bs.tab", (function(e) {
                0 == u && (c.render(), u = !0)
            }))
        }
    };
...
var KTSlidersWidget3 = function() {
    var e = function(e, t, a) {
        ...
        if (r && !r.classList.contains("initialized")) {
            ...
            }).render(), r.classList.add("initialized")
        }
    };
    return {
        init: function() {
            e("#kt_sliders_widget_3_chart_1", "danger", [18, 22, 22, 20, 20, 18, 18, 20, 20, 18, 18, 20, 20, 22]);
            var t = document.querySelector("#kt_sliders_widget_3_slider");
            t && t.addEventListener("slid.bs.carousel", (function(t) {
                1 === t.to && e("#kt_sliders_widget_3_chart_2", "primary", [18, 22, 22, 20, 20, 18, 18, 20, 20, 18, 18, 20, 20, 22])
            }))
        }
    }
}();
        ...
        s = (t, r) => {
            t.forEach(((i, o) => {
                const s = a.cloneNode(!0),
                    ...
                    m = s.querySelector('[data-kt-table-widget-4="template_total"]'),
                    p = s.querySelector('[data-kt-table-widget-4="template_stock"]'),
                    g = l.getAttribute("data-kt-src-path");
                l.setAttribute("src", g + i.image + ".gif"), n.innerText = i.name, d.innerText = i.description, c.innerText = i.cost, u.innerText = i.qty, m.innerText = i.total, i.stock > 10 ? p.innerHTML = '<div class="badge badge-light-success">In Stock</div>' : p.innerHTML = '<div class="badge badge-light-warning">Low Stock</div>', 1 === t.length || t.length;
            ...
            document.querySelectorAll('[data-kt-timeline-widget-1="tab"]').forEach((e => {
                e.addEventListener("shown.bs.tab", (a => {
                    "#kt_timeline_widget_1_tab_week" === e.getAttribute("href") && (() => {
                        ...
                        var a = Date.now(),
                            r = e.getAttribute("data-kt-timeline-widget-1-image-root"),
                            i = new vis.DataSet([{
                                id: 1,
                                content: "Research",
                                order: 1
                            ...
                            s = {
                                ...
                                template: function(e) {
                                    ...
                                    let a = "";
                                    return t.forEach((e => {
                                        a += `<div class="symbol symbol-circle symbol-25px"><img data-kt-timeline-avatar-src="${r + e}" alt="" /></div>`
                                ...
                                onInitialDrawComplete: function() {
                                    ...
                                    const a = e.closest('[data-kt-timeline-widget-1-blockui="true"]'),
                                        r = KTBlockUI.getInstance(a);
                                    r.isBlocked() && setTimeout((() => {
                                        r.release()
                                    }), 1e3)
                                }
                            };
                        const l = new vis.Timeline(e, o, i, s);
                        l.on("currentTimeTick", (() => {
                            l.off("currentTimeTick")
                        }))
    ...
    init: function() {
        ...
        (e = document.querySelector("#kt_timeline_widget_2_card")) && KTUtil.on(e, '[data-kt-element="checkbox"]', "change", (function(e) {
            var t = this.closest(".form-check"),
                a = this.closest("tr"),
                r = a.querySelector('[data-kt-element="bullet"]'),
                i = a.querySelector('[data-kt-element="status"]');
            !0 === this.checked ? (t.classList.add("form-check-success"), r.classList.remove("bg-primary"), r.classList.add("bg-success"), i.innerText = "Done", i.classList.remove("badge-light-primary"), i.classList.add("badge-light-success")) : (t.classList.remove("form-check-success"), r.classList.remove("bg-success"), r.classList.add("bg-success"), i.innerText = "In Process", i.classList.remove("badge-light-success"), i.classList.add("badge-light-primary"))
        }))
    }
};
